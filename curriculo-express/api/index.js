...
// Middleware para injetar os modelos no contexto
...
// Registra as rotas do currículo
// Note que as rotas aninhadas (ex: /pessoas/:pessoaId/experiencias)
// são tratadas pelos respectivos ficheiros de rota.
...
const eraseDatabaseOnSync = true; // Mudar para false antes do deploy final!
...
const criarDadosIniciais = async () => {
  try {
    ...
    const pessoa1 = await models.Pessoa.create({
      nome: 'Kaiki Barros', email: 'kaiki.teste@email.com', resumo: 'Estudante de Sistemas para Internet.',
      linkedinUrl: 'https://linkedin.com/in/',  githubUrl: 'https://github.com/kaikibarros'
    });
    ...
    await models.Formacao.create({ curso: 'Tecnólogo em Sistemas para Internet', instituicao: 'Universidade Católica de Pernambuco', dataInicio: '2024-02-01', pessoaId: pessoa1.id });
    ...
    const pessoa2 = await models.Pessoa.create({
      nome: 'Ana Souza', email: 'ana.teste@email.com', resumo: 'Desenvolvedora Frontend com experiência em React.',
      linkedinUrl: 'https://linkedin.com/in/', githubUrl: 'https://github.com/anasouza'
    });
    ...
    await models.Formacao.create({ curso: 'Ciência da Computação', instituicao: 'Universidade Federal', dataFim: '2022-07-30', pessoaId: pessoa2.id });
